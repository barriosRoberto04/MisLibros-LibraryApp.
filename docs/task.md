# Lista de Tareas - Limpieza de Comentarios y Documentacion

- [x] Eliminar emojis de todos los comentarios de codigo (Kotlin, Gradle, XML)
- [x] Eliminar banners de comentarios y divisores visuales (como lineas de signos de igual o guiones)
